...
public class CustomMethodsPractice {
    ...
    public static void helloWorld5Times() {/*for (int i = 0; i < 5; i++) {
    ...
    public static void helloCydeo5Times(){/*for(int i =0; i<5; i++){
            System.out.println("helloCydeo1");
        }
        ....
         */}

    //create a function that can print all the even numbers from 1~10==>evenNumbers
    public static void evenNumbers(){/*for(int i=2; i<11; i+=2){
