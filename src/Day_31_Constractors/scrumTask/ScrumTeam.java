...
public class ScrumTeam {
    ...
    public void removeTester(int emploeeID){
        testersList.removeIf(n-> n.employeeID==emploeeID);
    }

    public void removeDeveloper(int emploeeID){
        devopsList.removeIf(n-> n.employeeID==emploeeID);
    }
