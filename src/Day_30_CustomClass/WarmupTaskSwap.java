...
public class WarmupTaskSwap {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("totalNumbersOfZero = " + totalNumbersOfZero);
...
/*
1. write a program that can swap the first and last elements of
an ArrayList of Integers

2. Write a program that can move all the zeros to the last indexes
of ArrayList
